...
from model.mp_deterministic import MessagePassing
...
class ONGNNConv(MessagePassing):
    ...
    def forward(self, x, edge_index, last_tm_signal):
        ...
        tm_signal = tm_signal_raw.repeat_interleave(repeats=int(self.params.gcn_dim / self.params.chunk_size), dim=1)
