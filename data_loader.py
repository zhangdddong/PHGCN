...
class TrainDataset(Dataset):
    ...
    def __init__(self, triples, params):
        ...
        :param triples: The triples used for training the model
        :param params: Parameters for the experiments
        :return: A training Dataset class instance used by DataLoader
        """
...
class TestDataset(Dataset):
    ...
    def __init__(self, triples, params):
        ...
        :param triples: The triples used for evaluating the model
        :param params: Parameters for the experiments
        :return: An evaluation Dataset class instance used by DataLoader for model evaluation
        """
        self.triples = triples
        self.p = params
